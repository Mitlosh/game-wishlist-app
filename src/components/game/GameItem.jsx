      ...
      {isGrid ? (
        ...
        <Column>
          ...
          <div className="card-list-bottom">
            ...
            <div className="block-wrap d-flex align-items-end justify-content-between">
              <button onClick={() => removeFromPlaylist(gameItem)} className="card-list-button text-uppercase">
                Remove
              </button>
              <Link to={`/games/${gameItem?.id}`} className="card-list-button text-uppercase">
                see more
              </Link>
            </div>
          </div>
